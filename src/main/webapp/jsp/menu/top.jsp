	...
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark mb-5">
	  ...
	  <ul class="navbar-nav">
		...
		<c:if test="${not empty SESS_LOGIN_INFO}">
			...
			<!-- 마이페이지 -->
			<li class="nav-item">
				<a class="nav-link" href="<c:url value='/member/my_page.do' />">MyPage</a>
			</li>
			<!-- 회원 게시판 -->
			<li class="nav-item">
		...
		<li class="nav-item ml-4" >
			<button type="button" class="btn btn-sm btn-primary ml-2 mt-1" data-toggle="modal" data-target="#paramDashBoard" >인자 현황</button>
		</li>
		<!-- //인자 현황 대시(dash) 보드 : 팝업(모달) -->
