		...
		<form name="frm" class="form" method="post" action="<c:url value='/board/board_update.do' /> ">
			...
			<table class="table table-borderless my-3">
				<tr>
					...
					<td><input type="text" size="12" name="name" class="form-control my-2 bg-white"
				...
				<tr>
					...
					<td><input type="text" size="40" maxlength="50" name="email" class="form-control my-2"
				...
				<tr>
					...
					<td><textarea cols="70" rows="8" name="content" class="form-control my-2">${board.content}</textarea></td>
				</tr>
			</table>
			<br>
			<br> 
