...
public class BoardService {
	...
	public List<BoardVO> selectBoardsByPaging(SearchVO searchVO) {
		...
		try {
			...
			log.error("BoardService.selectBoardsByPaging 조회 에러");
			e.printStackTrace();
		}
	...
	public List<BoardVO> selectBoardsBySearchPaging(SearchVO searchVO) {
		...
		try {
			...
			log.error("BoardService.selectBoardsBySearchPaging 조회 에러");
			e.printStackTrace();
		}
	...
	public boolean insertBoard(BoardVO boardVO) {
		...
		try {
			...
			log.error("BoardService.insertBoard 저장 에러");
			e.printStackTrace();
		}
	...
	public boolean updateReadCount(int num) {
		...
		try {
			...
			transactionManager.rollback(txStatus);
			log.error("BoardService.updateReadCount 저장 에러");
			e.printStackTrace();
		}
	...
	public boolean updateBoard(BoardVO boardVO) {
		...
		try {
			...
			transactionManager.rollback(txStatus);
			log.error("BoardService.updateBoard 저장 에러");
			e.printStackTrace();
		}
	...
	public boolean deleteBoard(int num) { 
		...
		try {
			...
			transactionManager.rollback(txStatus);
			log.error("BoardService.deleteBoard 삭제 에러");
			e.printStackTrace();
		}
