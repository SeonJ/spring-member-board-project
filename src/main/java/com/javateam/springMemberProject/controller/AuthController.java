...
//			forwardPage = "/member/my_page";
//		}
		return session.getAttribute("SESS_LOGIN_INFO") != null ? "/member/my_page" : "/auth/login";
//		return forwardPage;
	}
